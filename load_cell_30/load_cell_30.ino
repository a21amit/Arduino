...
void setup() {
  ...
  calibrationValue_1 = 56.36; // uncomment this if you want to set this value in the sketch
  calibrationValue_2 = 105.59; // uncomment this if you want to set this value in the sketch
  calibrationValue_3 = 57.16; // uncomment this if you want to set this value in the sketch
